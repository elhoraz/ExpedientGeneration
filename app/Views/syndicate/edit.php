...
<?= $this->section('title') ?>
Ubah Data Bisnis - The Syndicate
<?= $this->endSection() ?>
...
<style>
    ...
    .logo-preview-box {
        ...
        margin: 0 auto 15px; overflow: hidden; display: flex; align-items: center; justify-content: center;
...
<div class="create-syndicate-container">
    ...
    <div class="form-black-card" data-tilt data-tilt-glare data-tilt-max-glare="0.1" data-tilt-scale="1.01">
        ...
        <form action="<?= base_url('syndicate/update/' . $bisnis['id']) ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-input" id="kategori" name="kategori" required>
                    ...
                    <option value="Kreatif" <?= old('kategori', $bisnis['kategori']) == 'Kreatif' ? 'selected' : '' ?>>Kreatif</option>
                    <option value="Retail" <?= old('kategori', $bisnis['kategori']) == 'Retail' ? 'selected' : '' ?>>Retail</option>
                </select>
            </div>
                ...
                <div class="file-upload-box" id="logoUploadBox">
                    <div class="logo-preview-box" id="logoPreviewBox" style="display: flex;">
                        <?php if (!empty($bisnis['logo_bisnis'])): ?>
                            <img src="<?= base_url('uploads/bisnis/' . $bisnis['logo_bisnis']) ?>" id="logoPreviewImg" alt="Preview">
                        <?php else: ?>
                            <img src="" id="logoPreviewImg" alt="Preview" style="display:none;">
                            <i class="fa-solid fa-image" style="font-size: 2rem; color: #555;"></i>
                        <?php endif; ?>
                    </div>
        ...
        fileInput.addEventListener('change', function() {
            ...
            if (file) {
                ...
                reader.addEventListener('load', function() {
                    ...
                    uploadText.innerHTML = `<i class="fa-solid fa-check-circle" style="color:#00ff88"></i> Logo Baru Terdeteksi`;
                });
